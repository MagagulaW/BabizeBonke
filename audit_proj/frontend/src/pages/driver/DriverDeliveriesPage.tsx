...
type Delivery = { id: string; order_id: string; status: string; is_mine: boolean; restaurant_name: string; address_line1: string; city: string; province: string; driver_payout_estimate: string | number; total_amount: string | number; placed_at: string; delivery_instructions?: string | null; customer_nav_url?: string | null; restaurant_nav_url?: string | null; };
...
export function DriverDeliveriesPage() {
  ...
  useEffect(() => {
    ...
    socket.on('delivery:accepted', () => { void load(); });
